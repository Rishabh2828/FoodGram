...
public class BurgerActivity extends AppCompatActivity {
   ...
   public ArrayList<meal_model> list = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        burger_rv = findViewById(R.id.burger_rv);
        database = FirebaseFirestore.getInstance();
        backbtn = findViewById(R.id.burger_backbtn);




        meal_adapter meal_adapter = new meal_adapter(this,list);
        burger_rv.setAdapter(meal_adapter);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false);
        burger_rv.setLayoutManager(linearLayoutManager);
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(BurgerActivity.this, MainActivity.class);
