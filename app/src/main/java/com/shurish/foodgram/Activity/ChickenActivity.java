...
public class ChickenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chicken_rv = findViewById(R.id.chicken_rv);
        database = FirebaseFirestore.getInstance();
        backbtn = findViewById(R.id.chicken_backbtn);


        ArrayList<meal_model> list = new ArrayList<>();

        meal_adapter meal_adapter = new meal_adapter(this,list);
        chicken_rv.setAdapter(meal_adapter);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false);
        chicken_rv.setLayoutManager(linearLayoutManager);
