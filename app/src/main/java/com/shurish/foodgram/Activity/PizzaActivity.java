...
public class PizzaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pizza_rv = findViewById(R.id.pizza_rv);
        database = FirebaseFirestore.getInstance();
        backbtn = findViewById(R.id.pizza_backbtn);


        ArrayList<meal_model> list = new ArrayList<>();

        meal_adapter meal_adapter = new meal_adapter(this,list);
        pizza_rv.setAdapter(meal_adapter);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false);
        pizza_rv.setLayoutManager(linearLayoutManager);
